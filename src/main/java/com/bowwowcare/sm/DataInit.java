...
public class DataInit {
    ...
    public void init() {
        ...
        AggressionResult aggressionResult1 = surveyService.save_aggression(
        ...
        AggressionResult aggressionResult2 = surveyService.save_aggression(
                AggressionResult.builder()
                        .situation("영역에 과도하게 집착하고 있어요.".getBytes())
                        .solution("좋아하는 사람, 낯선 사람 방문순으로 단계적으로 교정해보세요.".getBytes())
                        .build()
        );
        AggressionResult aggressionResult3 = surveyService.save_aggression(
                AggressionResult.builder()
                        .situation("가족을 심하게 졸졸 따라다니고 있어요.".getBytes())
                        .solution("아이만의 공간을 만들어 그곳에서 편히 먹거나 쉬도록 켄넬교육을 시켜보세요.".getBytes())
                        .build()
        );
        AggressionResult aggressionResult4 = surveyService.save_aggression(
                AggressionResult.builder()
                        .situation("새로운 곳으로 이사하거나 새로운 가족이 생겼어요.".getBytes())
                        .solution("아이만의 공간을 만들어 그곳에서 편히 먹거나 쉬도록 켄넬교육을 시켜보세요.".getBytes())
                        .build()
        );
        AggressionResult aggressionResult5 = surveyService.save_aggression(
                AggressionResult.builder()
        ...
        AggressionResult aggressionResult6 = surveyService.save_aggression(
                AggressionResult.builder()
        ...
        AggressionResult aggressionResult7 = surveyService.save_aggression(
                AggressionResult.builder()
        ...
        AnxietyResult anxietyResult1 = surveyService.save_anxiety(
        ...
        AnxietyResult anxietyResult2 = surveyService.save_anxiety(
                AnxietyResult.builder()
        ...
        AnxietyResult anxietyResult3 = surveyService.save_anxiety(
                AnxietyResult.builder()
        ...
        AnxietyResult anxietyResult4 = surveyService.save_anxiety(
                AnxietyResult.builder()
